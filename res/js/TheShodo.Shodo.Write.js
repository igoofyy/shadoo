...
TheShodo.Shodo.Write.initialize = function () {
    ...
    $('#shop-desc').fadeIn('fast', function () { $('body').addClass('write-ready'); });
...
TheShodo.Shodo.Write.selectBrush = function (brushName) {
    ...
    $('#shop-desc *').css('visibility', 'visible').animate({ opacity: 1 });
...
TheShodo.Shodo.Write.attachButtonEvents = function () {
    ...
    // [Shop]
    $('#button-shop').click(function(e) {
        window.open("https://asianbrushpainters.com/");
    });

    $('#shop_now_button').click(function(e) {
        window.open("https://asianbrushpainters.com/");
    })
